package com.yovvis.ysrpc.registry.zookeeper;
...
//    private static final String ZK_ROOT_PATH = "/rpc/zk";
    ...
    public void init(RegistryConfig registryConfig) {
        ...
        serviceDiscovery = ServiceDiscoveryBuilder.builder(ServiceMetaInfo.class).client(client).basePath(RpcConstant.RPC_ZOOKEEPER_ROOT_PATH).serializer(new JsonInstanceSerializer<>(ServiceMetaInfo.class)).build();
    ...
    public void register(ServiceMetaInfo serviceMetaInfo) throws Exception {
        ...
        // 添加节点信息到本地缓存
        String registerKey = RpcConstant.RPC_ZOOKEEPER_ROOT_PATH + "/" + serviceMetaInfo.getServiceNodeKey();
    ...
    public void watch(String serviceNodeKey) {
        String watchKey = RpcConstant.RPC_ZOOKEEPER_ROOT_PATH + "/" + serviceNodeKey;
